            ...
            <Stack spacing={8} direction="column" sx={{ marginBottom: 4 }}>
             ...
             <Typography variant="h2">Choose Theme</Typography>
                ...
                <Grid container spacing={3}>
                    <Grid item xs>
                        <ThemeCard theme={"Improving Physical Wellness"} themes={themes} setThemes={setThemes} />
                    </Grid>
                    <Grid item xs>
                        <ThemeCard theme={"Strengthening Mental Wellness"} themes={themes} setThemes={setThemes} />
                    </Grid>
                    <Grid item xs>
                        <ThemeCard theme={"Being More Mindful"} themes={themes} setThemes={setThemes} />
                    </Grid>
                    <Grid item xs>
                        <ThemeCard theme={"Let's get that Bread"} themes={themes} setThemes={setThemes} />
                    </Grid>
                    <Grid item xs>
                        <ThemeCard theme={"Building Stronger Community"} themes={themes} setThemes={setThemes} />
                    </Grid>
                </Grid>
                </Stack>
                <YellowButton 
